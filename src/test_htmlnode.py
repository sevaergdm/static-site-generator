...
class TestHTMLNode(unittest.TestCase):
    def test_props_to_html(self):
        node = HTMLNode("a", "google", None, {"href": "https://www.google.com", "target": "some_target"})
        self.assertEqual(node.props_to_html(), ' href="https://www.google.com" target="some_target"')
    ...
    def test_to_html_parent_no_children(self):
        ...
        with self.assertRaises(ValueError) as context:
            parent_node.to_html()
        self.assertEqual(str(context.exception), "A list of child nodes must be provided")
    ...
    def test_to_html_parent_with_props(self):
        ...
        parent_node = ParentNode("a", [child_node, child_node2], {"href": "https://www.google.com"})
        self.assertEqual(parent_node.to_html(), '<a href="https://www.google.com"><p>This is some text</p><b>This is some more text</b></a>')
